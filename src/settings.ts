...
export class Settings extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.setDesc(
				"Show the vault Name in the status bar (vault list in submenu)",
			)
			.addToggle((toggle) =>
				toggle
		...
		new Setting(containerEl)
			...
			.setDesc(
				"Maximum number of characters to display in the vault name",
			)
			.addSlider((slider) =>
				slider
					.setLimits(5, 30, 1)
		...
		new Setting(containerEl)
			...
			.setDesc(
				"Show a control in the status bar to adjust the editor line width",
			)
			.addToggle((toggle) =>
				toggle
		...
		new Setting(containerEl)
			...
			.setDesc(
				"Choose the color of the line width icon in the status bar",
			)
			.addColorPicker((color) =>
				color
		...
		new Setting(containerEl)
			...
			.setDesc(
				"Restore cursor position and selection when closing the line width popup",
			)
			.addToggle((toggle) =>
				toggle
